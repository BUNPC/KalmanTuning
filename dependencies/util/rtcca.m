...
% Alexander von Lühmann, written in 2018 at TUB and published in
%
% von Lühmann, Alexander, et al. "A new blind source separation framework for 
% signal analysis and artifact rejection in functional Near-Infrared Spectroscopy." NeuroImage, vol 200, 2019.
...
% versions Matlab's canoncorr was used). This is described in 
%
% von Lühmann, Alexander, et al. "Improved physiological noise regression in fNIRS:
% a multimodal extension of the General Linear Model using temporally embedded 
% Canonical Correlation Analysis" NeuroImage (2019/20).
%
...
%% Z-score signals
X = zscore(X);
[Y, ADD.tembAuxZ.mu, ADD.tembAuxZ.sigma] = zscore(aux_emb);


% %% Perform CCA with fNIRS signals and temporally embedded aux signals
% (for validation, this is the matlab native cca without regularization)
