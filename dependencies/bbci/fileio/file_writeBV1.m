function props= file_writeBV1(dat,hdr)
...
% Customized by A.O. to suit my needs



% opt= opt_proplistToStruct(varargin{:});
% props= {'WriteMrk'      10            'BOOL'
%         'WriteHdr'      0            'BOOL'
%        };
...
if fid==-1, error('cannot write to %s.eeg', fullName); end
fwrite(fid, cntX, 'int32');
fclose(fid);
